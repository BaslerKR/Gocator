...
public:
     ...
     */
    void Serialize(const GoDataTree& source, kObject out, kSize binarySize, StreamFx streamingFx) override;
     ...
     * @return                                  Output size.
     */
    kSize SerializedOutputSize(const GoDataTree& source, kSize binarySize) override;
...
private:
    ...
    void SerializeMessagePack(GoDataTreeIterator&& it, OutputWriter& writer,
        kSize binarySize, StreamFx streamingFx);
    ...
    // Serializes GoDataTree chunked binary.
    void SerializeChunkedBinary(GoDataTreeIterator& it, OutputWriter& writer);
