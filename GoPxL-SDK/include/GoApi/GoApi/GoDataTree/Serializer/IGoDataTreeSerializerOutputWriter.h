...
public:
    ...
    /**
     * Writes bytes into underlying buffer directly via a callback function.
     * 
     * @param streamingFx                       Function pointer to execute to write bytes directly to stream.
     */
    virtual void WriteByteArray(StreamFx streamingFx) = 0;
