...
public:
    ...
    */
    ...
    /**
     * Traverse through nodes and gather a list of parameters whose values have been changed.
     *
     * @param changedParamsList   Vector of recently changed parameters references (pointers).
     */
    virtual void RetrieveChangedParameters(std::vector <Go::Properties::Node*>& changedParamsList) {};

    /**
     * Traverse through nodes and clear every parameter's flag indicating its value has changed.
     *
     */
    virtual void ResetChangedParameters() {};
