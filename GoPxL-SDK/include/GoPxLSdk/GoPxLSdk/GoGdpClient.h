...
namespace GoPxLSdk
{
    ...
    public:
       ...
       /**
        * Get the IP address of the connected sensor.
        *
        * This can be used to identify which sensor a dataset originated from
        * when receiving data from multiple sensors simultaneously.
        *
        * @public                                @memberof GoGdpClient
        * @version             Introduced in 1.4.43.22
        * @return                                The IP address of the connected sensor.
        */
        kIpAddress IpAddress() const;

       /**
        * Get the port of the connected sensor.
        *
        * This can be used to identify which sensor a dataset originated from
        * when receiving data from multiple sensors simultaneously.
        *
        * @public                                @memberof GoGdpClient
        * @version             Introduced in 1.4.43.22
        * @return                                The port of the connected sensor.
        */
        k16u Port() const;
       ...
       /**
        * Get the data set received from the sensor over the Gocator Data Protocol.
        *
        * @public                                @memberof GoGdpClient
        * @version                               Introduced in 0.2.1.53.
