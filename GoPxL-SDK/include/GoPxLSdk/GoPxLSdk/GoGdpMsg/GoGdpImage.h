...
namespace GoPxLSdk
{
    ...
    public:
       ...
       /**
        * Deserializes video/image message.
        *
        * @public                @memberof GoGdpImage
        * @version               Introduced in 0.2.1.53.
       ...
       /**
        * Gets flag to indicate if image is flipped about X-axis.
        *
        * @public                @memberof GoGdpImage
        * @version               Introduced in 0.2.1.53.
       ...
       /**
        * Gets flag to indicate if image is flipped about Y-axis.
        *
        * @public                @memberof GoGdpImage
        * @version               Introduced in 0.2.1.53.
        * @return                True if flipped, false otherwise.
       ...
       /**
        * Gets flag to indicate if the image is column based or not.
        *
        * @public                @memberof GoGdpImage
        * @version               Introduced in 0.2.1.53.
