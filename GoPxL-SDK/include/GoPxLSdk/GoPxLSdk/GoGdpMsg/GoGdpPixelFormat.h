...
namespace GoPxLSdk
{
    ...
    */
    ...
    public:
        ...
        /**
         * Gets the number of bits for the given pixel format per pixel.
         * 
        ...
        /**
         * Determines whether a given pixel format is a native type.
         * 
         * @param type              The pixel format.
         * 
         * @return                  Boolean indicating if the given format is one of the FireSync types.
         */
        static const bool IsNative(FormatType type);

        /**
         * Converts a FormatType to a string representation.
         *
         * @param type              The pixel format.
         *
         * @return A constant character pointer (string) representing the pixel format.
         */
        static const char* ToString(FormatType type);
    };
}
