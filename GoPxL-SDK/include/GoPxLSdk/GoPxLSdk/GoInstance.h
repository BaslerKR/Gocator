...
public:
    ...
    /**
     * Gets the Gocator Data Protocol (Gdp) port of GoPxL instance.
     * 
     * @public                @memberof GoInstance
     * @version               Introduced in 1.1.50.15
    ...
    /**
     * Sets the Gocator Data Protocol (Gdp) port of GoPxL instance.
     * 
     * @public                      @memberof GoInstance
     * @version                     Introduced in 1.1.50.15
     * @param gdpPort               Port number to be used for Gocator Data Protocol.
     */
