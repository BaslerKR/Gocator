 ...
 *
 * @internal
 * Copyright (C) 2023-2026 by LMI Technologies Inc.
...
#define GO_PXL_SDK_VERSION_MINOR 5
#define GO_PXL_SDK_VERSION_RELEASE 62
#define GO_PXL_SDK_VERSION_BUILD 52
...
//
// GoPxL 1.4 introduced breaking changes to the REST API so major version is incremented from 7 to 8.
#define GO_PXL_SDK_API_VERSION_MAJOR    9
