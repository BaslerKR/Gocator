...
#include <kApi/Data/kPixelFormat.h>
 ...
 * - Rather than a pixel type, a pixel format should be specified, although legacy code may do the former.
 * - Accessing individual pixels is not always possible (specifically: for packed pixel formats).
 * - Each kPixelFormat has its own peculiarities. Accessing individual rows of pixels is often okay/efficient.
 * 
...
/**
 * Constructs a kImage object by pixel type (legacy method).
 *
...
#if defined(K_CPP)
/**
 * Constructs a kImage object by pixel type (legacy method) using a separate allocator for image array memory.
 *
 * @public                  @memberof kImage
 * @param   image           Receives the constructed image object.
 * @param   pixelType       Pixel type (must be a value type).
...
/**
 * Constructs a kImage object by pixel format.
 *
 * @public                  @memberof kImage
 * @param   image           Receives the constructed image object.
