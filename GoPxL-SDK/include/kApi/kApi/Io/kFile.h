 ...
 *
 * @internal
 * Copyright (C) 2004-2026 by LMI Technologies Inc.
...
/**
 * Provides access to the underlying O/S file handle. 
 * 
 * It is strongly recommended to avoid making direct use of the underlying O/S handle. 
 * Manipulating this handle may cause subsequent kFile methods to behave incorrectly. 
 ...
 * @return              File handle.
 */
kFx(kSize) kFile_Handle(kFile file);
