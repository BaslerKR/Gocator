 ...
 *
 * @internal
 * Copyright (C) 2008-2026 by LMI Technologies Inc.
...
/**
 * Check a list of IPv4 addresses.
 *
 * WARNING: IPv4 addresses are checked with kIpAddress_Parse() which is actually too permissive.
 *
 * @param   addressList     A string containing IPv4 addresses, delimited by comma, semicolon, or space.
 * @return                  kTRUE if the addresses are valid; kFALSE otherwise.
 */
kFx(kBool) xkUtils_IsAddressListValid(const kChar* addressList);
