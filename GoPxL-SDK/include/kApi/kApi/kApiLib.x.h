 ...
 *
 * @internal
 * Copyright (C) 2012-2026 by LMI Technologies Inc.
...
//Deprecated: Don't use this. It does nothing.
typedef k64s (kCall* kApiDateTimeQueryFx)();
kInlineFx(kStatus) kApiLib_SetDateTimeQueryHandler(kApiDateTimeQueryFx function)
{
    (void) function;
    return kOK;
}
